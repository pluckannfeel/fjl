                  ...
                  <Grid>
                    ...
                    <Grid.Col span={{ base: 6, sm: 1.75 }}>
                      <DateInput
                        ...
                        // placeholder={t("mirairo.form.occupation.placeholder")}
                        onChange={(value: DateValue) =>
                          formik.setFieldValue(`education[${index}].to`, value)
                        }
                        required
                        name={`education[${index}].to`}
                        // value={background.to}
                        value={
                          background.to ? dayjs(background.to).toDate() : null
                        }
                        error={getNestedError(
                          `education.${index}.to`,
                          formik.errors
